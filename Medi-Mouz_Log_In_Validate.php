...
<div style="background-color:#002f42" class="container-fluid"> 
 ...
 <!--- <img src="medi-mouz.png" class="img-thumbnail rounded float-start" alt="mm logo"> --->
		<div class="mr-auto w-75 p-2">
			<span><a href="Medi-Mouz_LoggedIn.html">Home</a> | 
...
$sql = "SELECT COUNT(username) as Usernames FROM `Doctor` WHERE `username` = '$uname' AND `password` = '$password'";
...
if  ($row_cnt[0] == 1) {
	header("Location: Medi-Mouz_Landing.php");
}else {
    header("Location: Medi-Mouz_LogIn_Failed_Attempt.html");
}
